  ...
  if (err) {
    return (
      <main className="mx-auto max-w-3xl p-4 sm:p-6 text-white">
        <Link href="/app/shopping/receipts" className="text-sm text-gray-300 hover:underline">
          ← Back to receipts
        </Link>
  ...
  return (
    <main className="mx-auto max-w-3xl p-4 sm:p-6 text-white">
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-2 text-sm">
              ...
              <div className="rounded-lg border border-white/20 p-2">
                ...
                <div className="font-semibold">
                  ...
                  <span className="text-gray-400 font-normal">
                    (${breakdown.nonfood.price.toFixed(2)} + ${breakdown.nonfood.tax.toFixed(2)}{" "}
                    tax)
                  </span>
                </div>
              </div>
      ...
      {viewerOpen && img && (
        ...
        >
          <div
            className="relative max-h-[92vh] w-full max-w-4xl overflow-hidden rounded-xl border border-white/20 bg-black"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between border-b border-white/10 px-3 py-2">
              <div className="text-sm text-gray-200">Receipt</div>
